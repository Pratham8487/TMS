...
const DynamicList: React.FC<DynamicListProps> = ({
  ...
  const adjustedPerPage =
    showAllInMobile && isMobile ? data.length : mentorsPerPage;
    ...
    <>
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <span
            onClick={
              index + adjustedPerPage < data.length ? nextMentor : undefined
            }
            className={`${
      ...
      <div
        className={`grid gap-12 pt-6 w-full place-items-center ${gridCols} ${
          showAllInMobile && isMobile ? "grid-cols-1 grid-rows-none" : ""
        }`}
      >
