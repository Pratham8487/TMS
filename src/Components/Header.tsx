...
const Header = () => {
    return (
        <>
                ...
                <div className="w-[14.75rem] h-[4.5rem] mt-[2rem] ml-[2rem] gap-2">
                ...
                <div className="w-[8rem] h-[3.25rem] mt-[3rem] ml-[52.75rem] gap-[1.5rem] flex">
                    <CiShoppingCart className="w-[3.25rem] h-[3.25rem] text-gray-700 cursor-pointer"/>
