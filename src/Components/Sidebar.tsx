        ...
        <>
            ...
            <div className={`w-[15.75rem] h-[64rem] fixed bg-white  top-0 left-0 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 md:relative md:translate-x-0 md:block z-40`}>
                ...
                <div className="w-[11.75rem] h-[15.5rem] top-[46.5rem] ml-[2rem] rounded-[0.625rem] bg-[#141522]">
                    ...
                    <h1 className="relative w-[6.5rem] h-[1.25rem] top-[4.4375rem] left-[2.625rem] font-[Plus Jakarta Sans] font-semibold text-[1rem] leading-[1.5] tracking-[-0.02em] text-center align-middle text-white">Help Center</h1>
