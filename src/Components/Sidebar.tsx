...
//       {/* Sidebar */}
//       <div
//         className={`w-[15.75rem] h-[76rem] fixed bg-white  top-0 left-0 transform  ${
    ...
    <>
      ...
      >
        ...
        <div className="w-[11.75rem] h-[19.75rem] mt-[6.25rem] ml-[2rem] gap-[1.5rem] bg-white">
          <Link
            to="/"
            className="my-2 flex items-center gap-2 w-[11.75rem] h-[2.75rem] px-4 py-2 font-medium text-gray-500 hover:bg-[#F5F5F7] hover:text-black rounded-lg"
          >
            <GrOverview />
            <p>Overview</p>
          </Link>
