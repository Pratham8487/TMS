...
export default function MessageSidebar() {
  ...
  return (
    <div className="w-[25rem] max-h-[42rem] py-4 px-1 bg-white">
      <div className="relative my-4 ">
        <input
          type="text"
          placeholder="Search Name"
          className="min-w-92 p-2 pl-6 pr-12 text-gray-700 rounded-xl outline-none shadow-xs focus:ring-2 focus:ring-indigo-500"
        />
        <img
          src={SearchIcon}
      ...
      <div className="w-full px-1 max-h-[30rem] pt-5 mt-10 overflow-y-auto overflow-x-hidden">
        {users.map((user) => (
          <div key={user.id}>
